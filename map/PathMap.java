...
public class PathMap
{
        ...
        Map<Coordinate, Integer> terrainCells, List<Coordinate> waypointCells)
    {
        ...
        for (int i = 0; i < sizeR; i++) {
            ...
            for (int j = 0; j < sizeC; j++) {
                ...
                cells[i][j] = coord; // fill up the cells array.
            }
        }
    } // end of initMap()

    // By the end of this function, you should have a working cells.
    ...
    public boolean isIn(int r, int c) {
        // this function just make sure that it's within the map limit.
        // Can be used when increment?
